...
class SparseMMatrixM :
 ...
 public:
  ...
  virtual void read_len_hdf5(
      const std::string namefile, const int i, int len_row[],
      int leng_off_row[]);  ///< Read lengths
  virtual void read_pos_hdf5(
      const std::string namefile, int i, int pos[], double val[]);  ///< Read pos
  virtual int read_dim_hdf5(
      const std::string namefile, const int i, int dim[]);  ///< Read dimensions
 virtual int read_hdf5(
