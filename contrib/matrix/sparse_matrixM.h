...

{
 ...
 public:
  ...
  virtual void read_len_hdf5(
      const std::string namefile, const int i, const int j, int len_row[], int leng_off_row[]);  ///< Read lengths
  virtual void read_pos_hdf5(const std::string namefile, const int i, const int j,int pos[]);  ///< Read pos
