...
// 
// 
// LIBMESH_DEFAULT_VECTORIZED_FE(0,LAGRANGE_XFEM)
// LIBMESH_DEFAULT_VECTORIZED_FE(0,L2_LAGRANGE_XFEM)
// 
template <>
 MGFE<0,LAGRANGE_XFEM>::MGFE (const FEType & fet) :
   MGFEbase (0,fet),
...
template <>
 MGFE<0,LAGRANGE_XFEM>::~MGFE(){}
template <>
void MGFE<0,LAGRANGE_XFEM>::attach_quadrature_rule (QBase *q)
 {
assert(q);
   this->_qrule = q;
 ...
 template <>
 unsigned int MGFE<0,LAGRANGE_XFEM>::n_shape_functions () const {
    return MGFE<0,LAGRANGE_XFEM>::n_dofs (this->_elem_type, this->_fe_type.order + this->_p_level);
  }
  
   template <>  const int MGFE<0,LAGRANGE_XFEM>::get_dim()       {return _dim;}  ///< Dimension (3 or 2) used in the 3D FEM (1< _dim < MDIM_FEM)
 template <>  const int MGFE<0,LAGRANGE_XFEM>::get_order()     {return _order;}///< Order of the shape functions 0=cpnst 1=linear 2=quad
 template <>  const int MGFE<0,LAGRANGE_XFEM>::get_NoShape()   {return _NoShape;}  ///< Number of shape functions of the fem
 template <>  const int MGFE<0,LAGRANGE_XFEM>::get_NoElNodes() {return _NoElNodes;}  ///< Number of nodes in the reference element (always ref quad)
 template <>  const int MGFE<0,LAGRANGE_XFEM>::get_GeomType()  {return _GeomType;}   ///< Geom type 1=HEXAHEDRAL 0=TETRAHEDRAL
 template <>  const int MGFE<0,LAGRANGE_XFEM>::get_FamType()   {return _FamType;}    ///< Family  (geom 1: Lagrangian =0  RT =1)
  
   // Gaussian points -----------------------------------------------------------------------------
 template <>  const int MGFE<0,LAGRANGE_XFEM>::get_NoGauss(){ return _NoGauss;}  ///< Number of Gaussian points in 1-2-3D (for example, for HEX27 ngauss[3]=(3,9,27))
  template <> const double  MGFE<0,LAGRANGE_XFEM>::get_xg(int i){          return  _xg[i];}          ///< gaussian points
  template <> const double MGFE<0,LAGRANGE_XFEM>::get_weight(int i){      return _weight[i];}            ///< Weight
  template <> const double & MGFE<0,LAGRANGE_XFEM>::get_phi(){     return  *phi;}           ///< Shape functions
  template <> const double & MGFE<0,LAGRANGE_XFEM>::get_dphidxez_map(){return  *_dphidxez_map;}      ///< Shape derivative functions in gaussian points
  template <> const double & MGFE<0,LAGRANGE_XFEM>::get_dphidxx_map(){ return  *_dphidxx_map;}       ///< Second order shape derivatives in Gaussian points
  
   // Dofs points ----------------------------------------------------------------------------------
 template <>  const double &  MGFE<0,LAGRANGE_XFEM>::get_xnodes(){return   *_xnodes;}              ///< xnode (hex or tetra) in (xi,eta,seta)
 template <>  const int &  MGFE<0,LAGRANGE_XFEM>::get_fem_conn(){ return *_fem_conn;}              ///< dof node coords (respect to _xnodes)
  // template <> const int     MGFE<0,LAGRANGE_XFEM>::get_deg(){return _deg;}                  ///< Polinomial degree
  
   // Nodes (NDOF_FEM) -----------------------------------------------------------------------------
 template <>  const double & MGFE<0,LAGRANGE_XFEM>::get_phi_map_nodes(){return   *_phi_map_nodes;   }          ///< Shape functions
 template <>  const double & MGFE<0,LAGRANGE_XFEM>::get_dphidxez_map_nodes(){return   *_dphidxez_map_nodes;} 
 
 
  

     template <>    void MGFE<0,LAGRANGE_XFEM>::get_dphi_arb_node(std::vector<double> NodeCoord, const int order, double InvJac[], double dphi[]){return ;}
  template <>    void MGFE<0,LAGRANGE_XFEM>::get_dphi_on_given_nodeG(int, double*, double*, double*, int){return ;}
  
   template <>    void MGFE<0,LAGRANGE_XFEM>::print_rec_xdmf(const std::string& filename,const std::string& namefem,const std::string& namelem){return ;}
   template <>    void MGFE<0,LAGRANGE_XFEM>::write(const std::string& filename){return ;}
   // template <>    void MGFE<0,LAGRANGE_XFEM>::init_pie_tri(){return ;}
   // template <>    double & MGFE<0,LAGRANGE_XFEM>::normal_g(double const*, double const*, double*) const{return ;}
   template <>    int MGFE<0,LAGRANGE_XFEM>::GetFamilyType(int elem_dof, int dim){return 1;}
  
  
 


   template <>    double MGFE<0,LAGRANGE_XFEM>::ComputeInverseMatrix_vol(double*, double*){return 0.;}
   
  // ========================================================
  // Jacobian  ----------------------------------------------------
  // ========================================================
  template <> double MGFE<0,LAGRANGE_XFEM>::Jac            (const int, const double*, double*){return 0.;}
  template <> double MGFE<0,LAGRANGE_XFEM>::JacG           (const int, const double*, double*, int, int){return 0.;}
  template <> double MGFE<0,LAGRANGE_XFEM>::JacobianOnGauss(const int, const int, const double*, double*){return 0.;}
  template <> double MGFE<0,LAGRANGE_XFEM>::JacobianOnPoint(const int, const double*, double*, double*, int, int){return 0. ;}
  template <> double MGFE<0,LAGRANGE_XFEM>::Jac_nodes      (const int ng, const double x[], double InvJac[])  {return 0.;}
  template <> double MGFE<0,LAGRANGE_XFEM>::JacSur(const int ng, const double x[], double InvJac[]) {return 0.;} 
    template<> double  MGFE<0,LAGRANGE_XFEM>::JacOnGivenCanCoords(const int dim,const double ElemCoords[], double CanCoords[], double InvJac[], int FamilyType, int nShape) { return 0.;}
   // normal --------------------------------------------------------
  template <>    void  MGFE<0,LAGRANGE_XFEM>::normal_g(double const*, double const*, double*, int&) const{return;}
  template <>    void  MGFE<0,LAGRANGE_XFEM>::normal_g(double const*, double const*, double*) const{return;}
   // ========================================================
    //  RETURN SHAPE FUNCTIONS AT GAUSS POINTS --------------------------------------------
    ///< \param[in]  <dim>    Dimension
    ///< \param[in]  <qp>     Gaussian point
    ///< \param[out] <phi>    Shape function
       template <>    void MGFE<0,LAGRANGE_XFEM>::get_dphi_g_arb_el(int, int, double const*, double*, int){return ;}
     template <>    void MGFE<0,LAGRANGE_XFEM>::get_phi_g_arb_el(const int dim, const int qp, double phi[], int FamilyType){return ;}
  
  
  
  
  
  template <>  bool MGFE<0,LAGRANGE_XFEM>::phys_to_ref(double xref[],double xphys[],const double Xel[], int max_it, double tol) {return false;}
  
//  LAGRANGE_XFEM
// template <>
//  Real MGFE<0,LAGRANGE_XFEM>::shape(const Elem *,  const Order,  const unsigned int libmesh_dbg_var(i),   const Point &,   const bool)
//  { assert (i< 1);   return 1.;
// }
// template <>
// Real MGFE<0,LAGRANGE_XFEM>::shape(const FEType,  const Elem *,    const unsigned int libmesh_dbg_var(i),
//                            const Point &,   const bool) {
//   libmesh_assert_less (i, 1);  return 1.;}
// 
template <> double  MGFE<0,LAGRANGE_XFEM>::shape(
  const ElemType,
  const Order,
...
//  L2-LAGRANGE_XFEM
// template <>
// Real MGFE<0,L2_LAGRANGE_XFEM>::shape(const ElemType,      const Order,      const unsigned int libmesh_dbg_var(i),
//                               const Point &) {libmesh_assert_less (i, 1);   return 1.;
// }
// template <> Real MGFE<0,L2_LAGRANGE_XFEM>::shape(const Elem *,  const Order,  const unsigned int libmesh_dbg_var(i), const Point &,  const bool)
// {  libmesh_assert_less (i, 1); return 1.;
// }

// template <> Real MGFE<0,L2_LAGRANGE_XFEM>::shape(const FEType,
//                               const Elem *,
...
// 
// template <>
// Real MGFE<0,L2_LAGRANGE_XFEM>::shape_deriv(const ElemType,     const Order,    const unsigned int,
//                                     const unsigned int,      const Point &)
// {libmesh_error_msg("No spatial derivatives in 0D!"); return 0.; }
// 
// 
// 
// template <> Real MGFE<0,L2_LAGRANGE_XFEM>::shape_deriv(const Elem *,     const Order,  const unsigned int,
...
// 
// 
template <> double MGFE<0,LAGRANGE_XFEM>::shape_deriv(
  const ElemType,
  const Order,
  const unsigned int,
   const unsigned int,
...
// 
// template <>
// Real MGFE<0,LAGRANGE_XFEM>::shape_deriv(const Elem *,
//                                  const Order,
//                                  const unsigned int,
//                                  const unsigned int,
//                                  const Point &,
...
// 
// template <>
// Real MGFE<0,L2_LAGRANGE_XFEM>::shape_deriv(const FEType,
//                                     const Elem *,
//                                     const unsigned int,
//                                     const unsigned int,
//                                     const Point &,
...
// 
// template <>
// Real MGFE<0,LAGRANGE_XFEM>::shape_deriv(const FEType,
//                                  const Elem *,
//                                  const unsigned int,
//                                  const unsigned int,
//                                  const Point &,
...
// 
// template <>
// double MGFE<0,L2_LAGRANGE_XFEM>::shape_second_deriv(const ElemType,
//                                            const Order,
//                                            const unsigned int,
//                                            const unsigned int,
//                                            const double &)
...
// 
// template <>
// Real MGFE<0,L2_LAGRANGE_XFEM>::shape_second_deriv(const Elem *,
//                                            const Order,
//                                            const unsigned int,
//                                            const unsigned int,
//                                            const Point &,
...
// }
// 
 template <>  double MGFE<0,LAGRANGE_XFEM>::shape_second_deriv(const ElemType,
                                         const Order,
                                         const unsigned int,
                                         const unsigned int,
                                         const double p[])
...
// 
// template <>
// Real MGFE<0,LAGRANGE_XFEM>::shape_second_deriv(const Elem *,
//                                         const Order,
//                                         const unsigned int,
//                                         const unsigned int,
//                                         const Point &,
...
// 
// template <>
// Real MGFE<0,L2_LAGRANGE_XFEM>::shape_second_deriv(const FEType,
//                                            const Elem *,
//                                            const unsigned int,
//                                            const unsigned int,
//                                            const Point &,
...
// 
// template <>
// Real MGFE<0,LAGRANGE_XFEM>::shape_second_deriv(const FEType,
//                                         const Elem *,
//                                         const unsigned int,
//                                         const unsigned int,
//                                         const Point &,
...
// 
// } // namespace libMesh
template <> double   MGFE<0,LAGRANGE_XFEM>:: compute_fe_gauss_points(
...
template <> double   MGFE<0,LAGRANGE_XFEM>:: compute_fe_face_gauss_points(
   const int  gp, // gaussian point gp
   const double xyz[] // x_elem[xyz(1),xyz(2), xyz(3),   xyz(_Nshape)] 
 ){
...
// 
// // =======================================================================================
// template <>  double MGFE<0,LAGRANGE_XFEM>::Tri_2d_LinearPhi(
//   int nPhi,
//   double point[]
// ) {// ====================================================================================
//   double PhiVal;
...
// }
// // =======================================================================================
// template <>  double MGFE<0,LAGRANGE_XFEM>::Tri_2d_QuadraticPhi(
//   int nPhi,
//   double point[]
// ) {// ====================================================================================
//   double PhiVal;
...
// }
// // =======================================================================================
// template <>  double MGFE<0,LAGRANGE_XFEM>::Tri_2d_LinearDerPhi(int nPhi, double */*point[]*/, int dir) {
//   double PhiDer;
//   PhiDer = _CooTriEl[nPhi * 3 + dir];
//   return PhiDer;
// }
// // =======================================================================================
// template <>  double MGFE<0,LAGRANGE_XFEM>::Tri_2d_QuadraticDerPhi(int nPhi, double point[], int dir) {
//   double PhiDer;
//   int m = nPhi / 3;
//   int l1 = (nPhi % 3);
//   int l2 = (l1 + 1) % 3;
...
// }
// // =======================================================================================
// template <>  double MGFE<0,LAGRANGE_XFEM>::Tri_2d_QuadraticDer2Phi(int nPhi, double point[], int dir1, int dir2) {
//   double Phi2Der;
//   int m = nPhi / 3;
//   int l1 = (nPhi % 3);
//   int l2 = (l1 + 1) % 3;
...
// }
// // =======================================================================================
// template <>  double MGFE<0,LAGRANGE_XFEM>::Tri_3d_LinearPhi(int nPhi, double point[]) {
//   double PhiVal;
...
// }
// // =======================================================================================
// template <>  double MGFE<0,LAGRANGE_XFEM>::Tri_3d_LinearDerPhi(int nPhi, double */*point[]*/, int dir) {
//   double PhiDer;
//   PhiDer = _CooTetra4[nPhi * 4 + dir];
//   return PhiDer;
// }
// // =======================================================================================
// template <>  double MGFE<0,LAGRANGE_XFEM>::Tri_3d_QuadraticPhi(int nPhi, double point[]) {
//   double PhiVal;
...
// }
// // =======================================================================================
// template <>  double MGFE<0,LAGRANGE_XFEM>::Tri_3d_QuadraticDerPhi(int nPhi, double point[], int dir) {
//   double PhiDer;
//   int l1 = _CooTetra10[nPhi * 4];
//   int l2 = _CooTetra10[nPhi * 4 + 1];
//   int a = _CooTetra10[nPhi * 4 + 2];
...
// }
// // =======================================================================================
// template <>  double MGFE<0,LAGRANGE_XFEM>::Tri_3d_QuadraticDer2Phi(int nPhi, double point[], int dir1, int dir2) {
//   double PhiDer;
//   int l1 = _CooTetra10[nPhi * 4];
//   int l2 = _CooTetra10[nPhi * 4 + 1];
//   int a = _CooTetra10[nPhi * 4 + 2];
...
// // =======================================================================================
// template <>
//  double MGFE<0,LAGRANGE_XFEM>::Edge_Quad_Phi(int PhiCoeff, double Coordinate) {
//   double PhiVal;
...
// // ======================================================================================
// template <>
//  double MGFE<0,LAGRANGE_XFEM>::Edge_Quad_DPhi(int PhiCoeff, double Coordinate) {
//   double DPhiVal;
...
// // ======================================================================================
// template <>
//  double MGFE<0,LAGRANGE_XFEM>::Edge_Quad_D2Phi(int PhiCoeff, double /*Coordinate*/) {
//   double D2PhiVal;
...
// // ======================================================================================
// template <>
//  double MGFE<0,LAGRANGE_XFEM>::Edge_Lin_Phi(int PhiCoeff, double Coordinate) {
//   double PhiVal;
...
// // ======================================================================================
// template <>
//  double MGFE<0,LAGRANGE_XFEM>::Edge_Lin_DPhi(int PhiCoeff, double /*Coordinate*/) {
//   double DPhiVal;
...
// // ======================================================================================
// template <>
//  double MGFE<0,LAGRANGE_XFEM>::Rec_Lin_Phi(int nPhi, double point[], int dimension) {
//   double PhiVal = 1.;
// 
...
// // ======================================================================================
// template <>
//  double MGFE<0,LAGRANGE_XFEM>::Rec_Quad_Phi(int nPhi, double point[], int dimension) {
//   double PhiVal = 1.;
// 
//   for(int dir = 0; dir < dimension; dir++) {
//     int lambda_i;
...
// // ======================================================================================
// template <>
//  double MGFE<0,LAGRANGE_XFEM>::Rec_Lin_DPhi(int nPhi, double point[], int dimension, int DirDer) {
//   int lambda_i;
// 
//   if(dimension == 1) {
//     lambda_i = _CooE3[nPhi];
...
// // ======================================================================================
// template <>
//  double MGFE<0,LAGRANGE_XFEM>::Rec_Quad_DPhi(int nPhi, double point[], int dimension, int DirDer) {
//   int lambda_i;
// 
//   if(dimension == 1) {
//     lambda_i = _CooE3[nPhi];
...
// // ======================================================================================
// template <>
//  double MGFE<0,LAGRANGE_XFEM>::Rec_Lin_D2Phi(int nPhi, double point[], int dimension, int DirDer1, int DirDer2) {
//   double PhiDer;
// 
//   if(DirDer1 == DirDer2) {
//     PhiDer = 0.;
...
// // ======================================================================================
// template <>
//  double MGFE<0,LAGRANGE_XFEM>::Rec_Quad_D2Phi(int nPhi, double point[], int dimension, int DirDer1, int DirDer2) {
//   double PhiDer;
// 
//   if(DirDer1 == DirDer2) {
//     int lambda_i;
...
// 
// template <>
//  double MGFE<0,LAGRANGE_XFEM>::FirstDerivateOfLocalPhi(int nPhi, double point[], int Dimension, int DirDer, int FamilyType) {
//   double PhiDer;
// 
...
// 
// 
// template <> void MGFE<0,LAGRANGE_XFEM>::init_pie_rec() { return;}
// template <> void MGFE<0,LAGRANGE_XFEM>::init_lin_rec() { return;}
// template <> void MGFE<0,LAGRANGE_XFEM>::init_lin_rec_rt() { return;}
// template <> void MGFE<0,LAGRANGE_XFEM>::init_lin() { return;}
// template <> void MGFE<0,LAGRANGE_XFEM>::init_pie() { return;}
// 
// 
// 
// // LLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLL
// template <> void MGFE<0,LAGRANGE_XFEM>::init_lin_tri(
// ) {// LLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLL
// 
// 
//   return;
...
// 
// 
// // template <> double MGFE<0,LAGRANGE_XFEM>::ComputeInverseMatrix(double *,double *,int) { return 0.;}
template <> double MGFE<0,LAGRANGE_XFEM>::ComputeInverseMatrix_sur(double *,double *) { return 0.;}
// // template <> double MGFE<0,LAGRANGE_XFEM>::FirstDerivateOfLocalPhi(int , double *,int,int,int) { return 0.;}
// 
...
// //    QUAD
// // ============================================================================
// template<> void  MGFE<0,LAGRANGE_XFEM>::init_qua_rec(
// ) {//==========================================================================
...
// 
// // ================================================================================
// template<> void  MGFE<0,LAGRANGE_XFEM>::init_qua_tri() {
//   /*           ********************************************
//   //                               TRI 6
//   //     ********************************************
//   //                              2
...
// template<> void  MGFE<0,LAGRANGE_XFEM>::init_qua() {  // ================================
...
template <>
void MGFE<0,LAGRANGE_XFEM>::normal_g(
...
//=============================================================
template <>
void  MGFE<0,LAGRANGE_XFEM>::Oxy_face(
...
// 
template <> void MGFE<0,LAGRANGE_XFEM>::set_par(std::string fileh5,int dim_in,int order_in,int shapes_quad,int geom_type_in,int fam_type_in)  
...
template <> void  MGFE<0,LAGRANGE_XFEM>::get_dphi_on_given_node(const int dim, double ElemCoords[], double CanPos[], double dphi[]) {
...
template <> void  MGFE<0,LAGRANGE_XFEM>::get_phi_gl_g(
...
template <> void  MGFE<0,LAGRANGE_XFEM>::get_dphi_gl_g(
const int qp,           // gaussian point <
...
template <> void  MGFE<0,LAGRANGE_XFEM>::get_ddphi_gl_g(
const int qp,           // gaussian point <
const double InvJac[],  // Jacobean
...
template <> void  MGFE<0,LAGRANGE_XFEM>::get_dphi_node(
const int /*kdim*/,         // dimension <-
...
// //===============================================================================================
//  template<>
// std::array<double,3 >   MGFE<0,LAGRANGE_XFEM>::Rec_RT_Phi(int iface, double x[],int dim) {
// 
// 
//   return {0.,0.,0.};
// }
...
// 
// template<>
// std::array<double,3>   MGFE<0,LAGRANGE_XFEM>::Rec_RT_DPhi(int /*iface*/, double x[],int dim,  int dir) {
//   return  {0.,0.,0.};  
// }
...
//===============================================================================================
template<>
double  MGFE<0,LAGRANGE_XFEM>::ComputeInverseMatrix(double Matrix[], double InvMatrix[], int dim) {
  double det = 0.;
...
//===============================================================================================
template<>
double  MGFE<0,LAGRANGE_XFEM>::Tj_interp_lin(double *u,int j, double *xi,int ndof,int idim) {
...
//===============================================================================================
template<>
double  MGFE<0,LAGRANGE_XFEM>::dTjdxi_lin(double *u,int j, double *xi,int i,int ndof,int idim) {
  double sum=0.; /*int ndof=8;*/
