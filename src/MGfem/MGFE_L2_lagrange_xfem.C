...
//==============================================================================
int lagrange_refspace_xfem_n_nodes(const ElemType itemType,int geo_mesh){
...
// 
// ===============================================================
 unsigned int lagrange_xfem_n_dofs(
   const ElemType t, 
   const Order o
){// ===============================================================
  switch (o)  {
...
// 
// ==================================================================
unsigned int lagrange_xfem_n_dofs_at_node(
  const ElemType t,
  const Order o,
...
// LIBMESH_FE_NODAL_SOLN(LAGRANGE, lagrange_xfem_nodal_soln)
// LIBMESH_FE_SIDE_NODAL_SOLN(LAGRANGE)


// template <>  int MGFE<0,LAGRANGE_XFEM>::get_refspace_n_nodes(const ElemType itemType, const int o){  return lagrange_refspace_xfem_n_nodes(itemType,o);}
// template <>  int MGFE<1,LAGRANGE_XFEM>::get_refspace_n_nodes(const ElemType itemType, const int o){  return lagrange_refspace_xfem_n_nodes(itemType,o);}
// template <>  int MGFE<2,LAGRANGE_XFEM>::get_refspace_n_nodes(const ElemType itemType, const int o){  return lagrange_refspace_xfem_n_nodes(itemType,o);}
// template <>  int MGFE<3,LAGRANGE_XFEM>::get_refspace_n_nodes(const ElemType itemType, const int o){  return lagrange_refspace_xfem_n_nodes(itemType,o);}

// 
// // Do full-specialization for every dimension, instead
// // of explicit instantiation at the end of this function.
// // This could be macro-ified.
template <> unsigned int MGFE<0,LAGRANGE_XFEM>::n_dofs(const ElemType t, const Order o) { return lagrange_xfem_n_dofs(t, o); }
template <> unsigned int MGFE<1,LAGRANGE_XFEM>::n_dofs(const ElemType t, const Order o) { return lagrange_xfem_n_dofs(t, o); }
template <> unsigned int MGFE<2,LAGRANGE_XFEM>::n_dofs(const ElemType t, const Order o) { return lagrange_xfem_n_dofs(t, o); }
template <> unsigned int MGFE<3,LAGRANGE_XFEM>::n_dofs(const ElemType t, const Order o) { return lagrange_xfem_n_dofs(t, o); }


// Do full-specialization for every dimension, instead
// of explicit instantiation at the end of this function.
template <> unsigned int MGFE<0,LAGRANGE_XFEM>::n_dofs_at_node(const ElemType t, const Order o, const unsigned int n) { return lagrange_xfem_n_dofs_at_node(t, o, n); }
template <> unsigned int MGFE<1,LAGRANGE_XFEM>::n_dofs_at_node(const ElemType t, const Order o, const unsigned int n) { return lagrange_xfem_n_dofs_at_node(t, o, n); }
template <> unsigned int MGFE<2,LAGRANGE_XFEM>::n_dofs_at_node(const ElemType t, const Order o, const unsigned int n) { return lagrange_xfem_n_dofs_at_node(t, o, n); }
template <> unsigned int MGFE<3,LAGRANGE_XFEM>::n_dofs_at_node(const ElemType t, const Order o, const unsigned int n) { return lagrange_xfem_n_dofs_at_node(t, o, n); }


// Lagrange elements have no dofs per element
// (just at the nodes)
template <> unsigned int MGFE<0,LAGRANGE_XFEM>::n_dofs_per_elem(const ElemType, const Order) { return 0; }
template <> unsigned int MGFE<1,LAGRANGE_XFEM>::n_dofs_per_elem(const ElemType, const Order) { return 0; }
template <> unsigned int MGFE<2,LAGRANGE_XFEM>::n_dofs_per_elem(const ElemType, const Order) { return 0; }
template <> unsigned int MGFE<3,LAGRANGE_XFEM>::n_dofs_per_elem(const ElemType, const Order) { return 0; }

// Lagrange FEMs are always C^0 continuous
template <> FEContinuity MGFE<0,LAGRANGE_XFEM>::get_continuity() const { return C_ZERO; }
template <> FEContinuity MGFE<1,LAGRANGE_XFEM>::get_continuity() const { return C_ZERO; }
template <> FEContinuity MGFE<2,LAGRANGE_XFEM>::get_continuity() const { return C_ZERO; }
template <> FEContinuity MGFE<3,LAGRANGE_XFEM>::get_continuity() const { return C_ZERO; }

// Lagrange FEMs are not hierarchic
template <> bool MGFE<0,LAGRANGE_XFEM>::is_hierarchic() const { return false; }
template <> bool MGFE<1,LAGRANGE_XFEM>::is_hierarchic() const { return false; }
template <> bool MGFE<2,LAGRANGE_XFEM>::is_hierarchic() const { return false; }
template <> bool MGFE<3,LAGRANGE_XFEM>::is_hierarchic() const { return false; }

// Lagrange FEM shapes do not need reinit (is this always true?)
// template <> bool MGFE<0,LAGRANGE_XFEM>::shapes_need_reinit() const { return false; }
// template <> bool MGFE<1,LAGRANGE_XFEM>::shapes_need_reinit() const { return false; }
// template <> bool MGFE<2,LAGRANGE_XFEM>::shapes_need_reinit() const { return false; }
// template <> bool MGFE<3,LAGRANGE_XFEM>::shapes_need_reinit() const { return false; }
...
// #ifdef LIBMESH_ENABLE_AMR
// template <>
// void MGFE<2,LAGRANGE_XFEM>::compute_constraints (DofConstraints & constraints,
//                                           DofMap & dof_map,
...
// 
// template <>
// void MGFE<3,LAGRANGE_XFEM>::compute_constraints (DofConstraints & constraints,
//                                           DofMap & dof_map,
//                                           const unsigned int variable_number,
//                                           const Elem * elem)
