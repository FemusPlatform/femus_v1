#ifndef __mggeomel3_h__
#define __mggeomel3_h__
...
// ====== embedding matrices
  ...
  static const float _embedding_matrix_f[4][4][4];
  static const int _surf_top[12];  ///< surface topology (side-> nodes)
  static const int _em_ord[4];// embedding matrix order
#endif
#if DIMENSION == 3
  ...
  static const float _embedding_matrix_l[8][8][8];  // Hex8
    static const float _embedding_matrix_f[8][6][6];  // Hex8
  static const int _surf_top[54];                   ///< surface topology (side-> nodes)
    static const int _em_ord[8];// embedding matrix order
#endif
