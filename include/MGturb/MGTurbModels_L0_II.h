 ...
 */
struct DYNturModels {
  double _nu; /// Molecular kinematic viscosity
  int _Park; /// Flag for Park limit
  int _YapCorr; /// Flag for Yap source term
  /// Vector used to store real \f$k\f$ and \f$\omega \f$ variables
  double _KappaAndOmega[2];
  double _LowerKappa, _LowerOmega;

  DYNturModels() : _Park(0), _YapCorr(0), _LowerKappa(1.e-12), _LowerOmega(1.e-12){};
