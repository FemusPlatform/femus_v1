...
//     Field = _field;
  ...
  void set_field(const MEDCoupling::MEDCouplingFieldDouble* f);  // field  <-
  ///< Setting the field (MEDfield)=================
  void set_field_source(const MEDCoupling::MEDCouplingFieldDouble* f);  // field  <-
